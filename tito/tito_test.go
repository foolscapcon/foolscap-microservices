...
func TestWebhooks(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			typ:      RegistrationCompletedPayload{},
			filename: "../testdata/tito/basic-payload.json",
			headers: http.Header{
				"X-Webhook-Name":  []string{"commit_comment"},
				"Tito-Signature": []string{"sha1=156404ad5f721c53151147f3d3d302329f95a3ab"},
			},
		},
